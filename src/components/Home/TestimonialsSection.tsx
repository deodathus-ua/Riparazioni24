      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {testimonials.map((testimonial) => (
            <div key={testimonial.id} className="bg-white p-6 rounded-lg shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
              ...
              <div className="mt-4">
                ...
                <p className="text-sm text-brand-blue mt-1">{testimonial.service}</p>
              </div>
            </div>
          ))}
        </div>
