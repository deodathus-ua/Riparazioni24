          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="https://www.instagram.com/assistenza__elettrodomestici?igsh=MXNiNXdpaXp5NGVpaA==" target="_blank" rel="noreferrer" aria-label="Instagram" className="bg-gradient-to-br from-pink-500 via-red-500 to-yellow-500 text-white p-3 rounded-full hover:opacity-90 transition-opacity">
