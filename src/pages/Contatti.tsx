            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+393331234567" className="text-brand-blue hover:text-brand-lightBlue font-semibold text-lg transition-colors">
                      333 123 4567
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@elettroassistenza-milano.it" className="text-brand-blue hover:text-brand-lightBlue font-semibold transition-colors break-words">
                      info@elettroassistenza-milano.it
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-1">La nostra sede operativa</p>
                    <p className="text-lg">
                      Via Esempio 123<br />
                      20100 Milano (MI)
                    </p>
              ...
              <div className="mt-10">
                <div className="bg-white rounded-lg shadow-md overflow-hidden h-[300px]">
                  <iframe 
                    title="ElettroAssistenza Milano Mappa"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2798.2849028033726!2d9.185918715748873!3d45.46398397910098!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4786c6a906033fa5%3A0x81f85280714a24d5!2sCorso%20Buenos%20Aires%2C%2020124%20Milano%20MI!5e0!3m2!1sit!2sit!4v1649751234567!5m2!1sit!2sit"
                    width="100%" 
                    height="300" 
                    style={{ border: 0 }}
                    allowFullScreen 
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a href="https://facebook.com" target="_blank" rel="noreferrer" className="bg-blue-600 text-white p-3 rounded-full hover:bg-blue-700 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                      <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path>
                    </svg>
                  </a>
                  <a href="https://instagram.com" target="_blank" rel="noreferrer" className="bg-gradient-to-br from-pink-500 via-red-500 to-yellow-500 text-white p-3 rounded-full hover:opacity-90 transition-opacity">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                  ...
                  <a href="https://wa.me/393331234567" target="_blank" rel="noreferrer" className="bg-green-600 text-white p-3 rounded-full hover:bg-green-700 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
